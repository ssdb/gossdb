...
func (c *Client) Set(key string, val interface{}, ttl ...int64) (err error) {
	...
	if err != nil {
		return errors.WithMessagef(err, "Set %s error", key)
	}
...
func (c *Client) SetNX(key string, val interface{}) (Value, error) {
	...
	if err != nil {
		return "", errors.WithMessagef(err, "Setnx %s error", key)
	}
	if len(resp) > 0 && resp[0] == oK {
...
func (c *Client) Get(key string) (Value, error) {
	...
	if err != nil {
		return "", errors.WithMessagef(err, "Get %s error", key)
	}
...
func (c *Client) GetSet(key string, val interface{}) (Value, error) {
	...
	if err != nil {
		return "", errors.WithMessagef(err, "Getset %s error", key)
	}
	if len(resp) == 2 && resp[0] == oK {
		return Value(resp[1]), nil
	}
...
func (c *Client) Expire(key string, ttl int64) (re bool, err error) {
	...
	if err != nil {
		return false, errors.WithMessagef(err, "Expire %s error", key)
	}
	if len(resp) == 2 && resp[0] == oK {
		return resp[1] == "1", nil
	}
...
func (c *Client) Exists(key string) (re bool, err error) {
	...
	if err != nil {
		return false, errors.WithMessagef(err, "Exists %s error", key)
	}
...
func (c *Client) Del(key string) error {
	...
	if err != nil {
		return errors.WithMessagef(err, "Del %s error", key)
	}
...
func (c *Client) TTL(key string) (ttl int64, err error) {
	...
	if err != nil {
		return -1, errors.WithMessagef(err, "Ttl %s error", key)
	}
...
func (c *Client) Incr(key string, num int64) (val int64, err error) {
	...
	if err != nil {
		return -1, errors.WithMessagef(err, "Incr %s error", key)
	}
	if len(resp) == 2 && resp[0] == oK {
		return Value(resp[1]).Int64(), nil
	}
...
func (c *Client) MultiSet(kvs map[string]interface{}) (err error) {
	...
	if err != nil {
		return errors.WithMessagef(err, "MultiSet %s error", kvs)
	}
...
func (c *Client) MultiGet(key ...string) (val map[string]Value, err error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "MultiGet %s error", key)
	}
...
func (c *Client) MultiGetSlice(key ...string) (keys []string, values []Value, err error) {
	...
	if err != nil {
		return nil, nil, errors.WithMessagef(err, "MultiGet %s error", key)
	}
...
func (c *Client) MultiDel(key ...string) (err error) {
	...
	resp, err := c.Do(args...)
	if err != nil {
		return errors.WithMessagef(err, "MultiDel %s error", key)
	}
...
func (c *Client) Setbit(key string, offset int64, bit int) (uint, error) {
	...
	if err != nil {
		return 0, errors.WithMessagef(err, "Setbit %s error", key)
	}
	if len(resp) == 2 && resp[0] == oK {
...
func (c *Client) Getbit(key string, offset int64) (uint, error) {
	...
	if err != nil {
		return 0, errors.WithMessagef(err, "Getbit %s error", key)
	}
	if len(resp) == 2 && resp[0] == oK {
		return Value(resp[1]).UInt(), nil
	}
...
func (c *Client) BitCount(key string, start int64, end int64) (int64, error) {
	...
	if err != nil {
		return 0, errors.WithMessagef(err, "BitCount %s error", key)
	}
	if len(resp) == 2 && resp[0] == oK {
...
func (c *Client) CountBit(key string, start int64, size int64) (int64, error) {
	...
	if err != nil {
		return 0, errors.WithMessagef(err, "CountBit %s error", key)
	}
	if len(resp) == 2 && resp[0] == oK {
		//fmt.Println(Value(resp[1]).String())
		return Value(resp[1]).Int64(), nil
...
func (c *Client) Substr(key string, start int64, size ...int64) (val string, err error) {
	...
	if err != nil {
		return "", errors.WithMessagef(err, "Substr %s error", key)
	}
...
func (c *Client) StrLen(key string) (int64, error) {
	...
	if err != nil {
		return -1, errors.WithMessagef(err, "Strlen %s error", key)
	}
	if len(resp) > 1 && resp[0] == oK {
		return Value(resp[1]).Int64(), nil
	}
...
func (c *Client) Keys(keyStart, keyEnd string, limit int64) ([]string, error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "Keys %s %s error", keyStart, keyEnd)
	}
	if len(resp) > 0 && resp[0] == oK {
		return resp[1:], nil
	}
...
func (c *Client) RKeys(keyStart, keyEnd string, limit int64) ([]string, error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "Rkeys %s %s error", keyStart, keyEnd)
	}
	if len(resp) > 0 && resp[0] == oK {
		return resp[1:], nil
	}
...
func (c *Client) Scan(keyStart, keyEnd string, limit int64) (map[string]Value, error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "Scan %s %s error", keyStart, keyEnd)
	}
	if len(resp) > 0 && resp[0] == oK {
...
func (c *Client) RScan(keyStart, keyEnd string, limit int64) (map[string]Value, error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "Rscan %s %s error", keyStart, keyEnd)
	}
	if len(resp) > 0 && resp[0] == oK {
		re := make(map[string]Value)
		size := len(resp)
