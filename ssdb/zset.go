...
func (c *Client) ZSet(setName, key string, score int64) (err error) {
	...
	if err != nil {
		return errors.WithMessagef(err, "Zset %s/%s error", setName, key)
	}
...
func (c *Client) ZGet(setName, key string) (score int64, err error) {
	...
	if err != nil {
		return 0, errors.WithMessagef(err, "Zget %s/%s error", setName, key)
	}
...
func (c *Client) ZDel(setName, key string) (err error) {
	...
	if err != nil {
		return errors.WithMessagef(err, "Zdel %s/%s error", setName, key)
	}
	if len(resp) > 0 && resp[0] == oK {
		return nil
	}
...
func (c *Client) ZExists(setName, key string) (re bool, err error) {
	...
	if err != nil {
		return false, errors.WithMessagef(err, "Zexists %s/%s error", setName, key)
	}
...
func (c *Client) ZCount(setName string, start, end interface{}) (count int64, err error) {
	...
	if err != nil {
		return -1, errors.WithMessagef(err, "Zcount %s %v %v error", setName, start, end)
	}
...
func (c *Client) ZClear(setName string) (err error) {
	...
	if err != nil {
		return errors.WithMessagef(err, "Zclear %s error", setName)
	}
...
func (c *Client) ZScan(setName string, keyStart string, scoreStart, scoreEnd interface{}, limit int64) (keys []string, scores []int64, err error) {
	...
	if err != nil {
		return nil, nil, errors.WithMessagef(err, "Zscan %s %v %v %v %v error", setName, keyStart, scoreStart, scoreEnd, limit)
	}
	if len(resp) > 0 && resp[0] == oK {
		size := len(resp)
...
func (c *Client) ZRScan(setName string, keyStart string, scoreStart, scoreEnd interface{}, limit int64) (keys []string, scores []int64, err error) {
	...
	if err != nil {
		return nil, nil, errors.WithMessagef(err, "Zrscan %s %v %v %v %v error", setName, keyStart, scoreStart, scoreEnd, limit)
	}
...
func (c *Client) MultiZSet(setName string, kvs map[string]int64) (err error) {
	...
	if err != nil {
		return errors.WithMessagef(err, "MultiZset %s %v error", setName, kvs)
	}
...
func (c *Client) MultiZGet(setName string, key ...string) (val map[string]int64, err error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "MultiZget %s %s error", setName, key)
	}
	size := len(resp)
	if size > 0 && resp[0] == oK {
...
func (c *Client) MultiZGetSlice(setName string, key ...string) (keys []string, scores []int64, err error) {
	...
	if err != nil {
		return nil, nil, errors.WithMessagef(err, "MultiZget %s %s error", setName, key)
	}
...
func (c *Client) MultiZDel(setName string, key ...string) (err error) {
	...
	resp, err := c.Do(args...)
	if err != nil {
		return errors.WithMessagef(err, "MultiZdel %s %s error", setName, key)
	}
...
func (c *Client) ZIncr(setName string, key string, num int64) (int64, error) {
	...
	if err != nil {
		return 0, errors.WithMessagef(err, "Zincr %s %s %v", setName, key, num)
	}
...
func (c *Client) ZList(nameStart, nameEnd string, limit int64) ([]string, error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "Zlist %s %s %v error", nameStart, nameEnd, limit)
	}
...
func (c *Client) ZSize(name string) (val int64, err error) {
	...
	if err != nil {
		return 0, errors.WithMessagef(err, "Zsize %s  error", name)
	}
...
func (c *Client) ZKeys(setName string, keyStart string, scoreStart, scoreEnd interface{}, limit int64) (keys []string, err error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "Zkeys %s %v %v %v %v error", setName, keyStart, scoreStart, scoreEnd, limit)
	}
	if len(resp) > 0 && resp[0] == oK {
		size := len(resp)
		keys := []string{}
...
func (c *Client) ZSum(setName string, scoreStart, scoreEnd interface{}) (val int64, err error) {
	...
	if err != nil {
		return 0, errors.WithMessagef(err, "Zsum %s %v %v  error", setName, scoreStart, scoreEnd)
	}
	if len(resp) > 0 && resp[0] == oK {
		val = Value(resp[1]).Int64()
		return val, nil
...
func (c *Client) ZAvg(setName string, scoreStart, scoreEnd interface{}) (val int64, err error) {
	...
	if err != nil {
		return 0, errors.WithMessagef(err, "Zavg %s %v %v  error", setName, scoreStart, scoreEnd)
	}
	if len(resp) > 0 && resp[0] == oK {
		val = Value(resp[1]).Int64()
		return val, nil
...
func (c *Client) ZRank(setName, key string) (val int64, err error) {
	...
	if err != nil {
		return 0, errors.WithMessagef(err, "Zrank %s %s  error", setName, key)
	}
	if len(resp) > 0 && resp[0] == oK {
		val = Value(resp[1]).Int64()
		return val, nil
...
func (c *Client) ZRRank(setName, key string) (val int64, err error) {
	...
	if err != nil {
		return 0, errors.WithMessagef(err, "Zrrank %s %s  error", setName, key)
	}
	if len(resp) > 0 && resp[0] == oK {
		val = Value(resp[1]).Int64()
		return val, nil
...
func (c *Client) ZRange(setName string, offset, limit int64) (val map[string]int64, err error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "Zrange %s %d %d  error", setName, offset, limit)
	}
	if len(resp) > 0 && resp[0] == oK {
		val = make(map[string]int64)
		size := len(resp)
...
func (c *Client) ZRangeSlice(setName string, offset, limit int64) (key []string, val []int64, err error) {
	...
	if err != nil {
		return nil, nil, errors.WithMessagef(err, "Zrange_slice %s %d %d  error", setName, offset, limit)
	}
	if len(resp) > 0 && resp[0] == oK {
		val = []int64{}
		key = []string{}
...
func (c *Client) ZRRange(setName string, offset, limit int64) (val map[string]int64, err error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "Zrrange %s %d %d  error", setName, offset, limit)
	}
	if len(resp) > 0 && resp[0] == oK {
		val = make(map[string]int64)
		size := len(resp)
...
func (c *Client) ZRRangeSlice(setName string, offset, limit int64) (key []string, val []int64, err error) {
	...
	if err != nil {
		return nil, nil, errors.WithMessagef(err, "Zrrange_slice %s %d %d  error", setName, offset, limit)
	}
	if len(resp) > 0 && resp[0] == oK {
		val = []int64{}
		key = []string{}
...
func (c *Client) ZRemRangeByRank(setName string, start, end int64) (err error) {
	...
	if err != nil {
		return errors.WithMessagef(err, "Zremrangebyrank %s %d %d  error", setName, start, end)
	}
	if len(resp) > 0 && resp[0] == oK {
		return nil
	}
...
func (c *Client) ZRemRangeByScore(setName string, start, end int64) (err error) {
	...
	if err != nil {
		return errors.WithMessagef(err, "Zremrangebyscore %s %d %d  error", setName, start, end)
	}
	if len(resp) > 0 && resp[0] == oK {
		return nil
	}
...
func (c *Client) ZPopFront(setName string, limit int64) (val map[string]int64, err error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "Zpopfront %s %d   error", setName, limit)
	}
	size := len(resp)
	if size > 0 && resp[0] == oK {
		val = make(map[string]int64)
...
func (c *Client) ZPopBack(setName string, limit int64) (val map[string]int64, err error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "Zpopback %s %d   error", setName, limit)
	}
	size := len(resp)
	if size > 0 && resp[0] == oK {
		val = make(map[string]int64)
